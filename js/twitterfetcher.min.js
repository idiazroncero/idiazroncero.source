        ...
        H = {
            ...
            callback: function(a) {
                ...
                for (b = 0; b < e;) {
                    ...
                    E && (d += '<p class="interact"><a href="https://twitter.com/intent/tweet?in_reply_to=' + m[b] + '" class="twitter-reply fa fa-reply"' +
                        (r ? ' target="_blank">' : ">") + '</a> · <a href="https://twitter.com/intent/retweet?tweet_id=' + m[b] + '" class="twitter-retweet fa fa-retweet"' + (r ? ' target="_blank">' : ">") + '</a> · <a href="https://twitter.com/intent/favorite?tweet_id=' + m[b] + '" class="twitter-fav fa fa-star"' + (r ? ' target="_blank">' : ">") + "</a></p>");
                ...
                if (null === A) {
                    ...
                    for (h = '<div class="twitter-header"><a href="http://www.twitter.com/idiazroncero" class="fa fa-twitter"></a></div></div><div class="twitter-open">{</div><div class="twitter-ul-wrapper"><ul>'; g < a;) h += "<li>" + c[g] + "</li>", g++;
                    f.innerHTML = h + '</ul></div><div class="twitter-close">}</div>'
                } else A(c);
                x = !1;
                ...
                slider = $('#twitter-fetcher ul').bxSlider({
                    pager:false,
                    mode:'vertical',
                    nextSelector: '.twitter-close',
                    nextText: '',
                    prevSelector: '.twitter-open',
                    prevText: '',
                    auto:true,
                    autoHover: true,
                    speed:1000,
                    ...
                    onSlideNext: function() {
                        $('.twitter-close').trigger('mouseenter');
                        setTimeout(function() {
                            $('.twitter-close').trigger('mouseleave');
                        },300);
                    },
                    onSlidePrev: function() {
                        $('.twitter-open').trigger('mouseenter');
                        setTimeout(function() {
                            $('.twitter-open').trigger('mouseleave');
                        },300);
                    }
                });
            }
